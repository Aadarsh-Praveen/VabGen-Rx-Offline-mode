  ...
  return (
    <div className="oos-card">
      ...
      <div className="oos-header">
        <span className="oos-title">📦 Out-of-Stock Medication Finder</span>
        <button className="oos-close-btn" onClick={() => setOutOfStock([])}>✕</button>
      </div>
        ...
        {outOfStock.map((entry, ei) => (
          <div key={ei} className="oos-entry">
            ...
            <div className="oos-drug-row">
              ...
              <span className="oos-drug-badge">🚫 Out of Stock (Hospital Pharmacy)</span>
            </div>
                    ...
                    <div key={ai} className="oos-table-row" style={{ opacity: inStock ? 1 : 0.5 }}>
                      ...
                      <div>
                        <div className="oos-brand-cell">
                          ...
                          {isLowest && inStock && <span className="oos-lowest-badge">+ Lowest Cost</span>}
                        </div>
                      ...
                      <button
                        ...
                        style={{
                          background: inStock ? "linear-gradient(135deg, #1a73e8, #1558b0)" : "#f0f0f8",
                          color: inStock ? "#fff" : "#bbb",
                          boxShadow: inStock ? "0 2px 8px rgba(26,115,232,0.25)" : "none",
                        }}
                      >
                        🔄 Switch
                      </button>
