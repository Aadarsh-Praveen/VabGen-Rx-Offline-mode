    ...
    <div className="login-container">
      ...
      {lockedEmail && (
        <AccountLockedModal
          ...
          onClose={() => { setLockedEmail(null); setFormData(prev => ({ ...prev, password: "" })); setMsg(null); }}
        />
      )}
            ...
            <form onSubmit={handleSubmit} noValidate>
              <div className="form-group">
                ...
                <div className="input-wrap">
                  ...
                  <input id="email" name="email" type="email" className="form-control has-icon"
                    placeholder="you@hospital.com" value={formData.email} onChange={handleChange} autoComplete="email" />
                </div>
              </div>
              ...
              <div className="form-group">
                ...
                <div className="input-wrap">
                  ...
                  <input id="password" name="password" type={showPwd ? "text" : "password"}
                    className="form-control has-icon" placeholder="••••••••"
