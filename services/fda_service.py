...
- Azure Application Insights logging added:
    Alert 3: FDA API failures and timeouts
             Custom events: fda_api_failure, fda_api_timeout
             Logged on non-200 responses and timeouts after
             retry in search_adverse_events(),
             _fetch_contraindications(), _fetch_dosing_label()
"""
